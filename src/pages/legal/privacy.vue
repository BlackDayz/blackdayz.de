    ...
    <div class="privacy my-4 mx-auto w-100 mx-5 px-5">
        ...
        <p>
            ...
            Schutze Ihrer Privatsphäre (<a
                ...
                target="_blank"
                class="black"
            >https://policies.google.com/privacy</a>). Google verarbeitet Ihre Daten in den USA und hat sich dem EU-US Privacy Shield
        ...
        <p />
        <p>
            <em>Die Datenschutzerklärung wurde mithilfe der activeMind AG erstellt, den Experten
                für
                <a
